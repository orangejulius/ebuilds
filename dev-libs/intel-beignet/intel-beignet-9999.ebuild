...
src_install() {
	...
	dosym lib64/beignet/libcl.so "${IBEIGNET_DIR}"/libOpenCL.so.1
	dosym lib64/beignet/libcl.so "${IBEIGNET_DIR}"/libOpenCL.so
	dosym lib64/beignet/libcl.so "${IBEIGNET_DIR}"/libcl.so.1
	dosym lib64/beignet/libcl.so "${IBEIGNET_DIR}"/libcl.so
}
