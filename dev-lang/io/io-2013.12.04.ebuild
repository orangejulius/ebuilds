...
src_prepare() {
	epatch "${FILESDIR}/io-2013.12.04-0001-Add-GNU-stack-note.patch"
	epatch "${FILESDIR}/io-2013.12.04-0002-Link-basekit-to-dl-for-as-needed-linking.patch"
	epatch "${FILESDIR}/io-2013.12.04-0003-Allow-configuring-which-addons-are-built.patch"
